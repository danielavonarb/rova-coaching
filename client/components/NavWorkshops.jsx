  ...
  return (
    ...
    <nav className = 'nav-pages'>
      <ul className = "nav__list-pages">
        ...
        <li className = "nav__item-pages" id="about-pages"><a onClick={handleClick} href = "/coaching" className = "nav__link-pages">Psychosoziale Beratung / Mentaltraining</a></li>
